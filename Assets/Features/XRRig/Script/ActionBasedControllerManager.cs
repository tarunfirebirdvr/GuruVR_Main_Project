...
public class ActionBasedControllerManager : MonoBehaviour
{
    ...
    [Serializable]
    public class StateUpdateEvent : UnityEngine.Events.UnityEvent { }
...
#pragma warning restore IDE0044
    ...
    UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor m_UIInteractor;
    UnityEngine.XR.Interaction.Toolkit.Interactors.Visuals.XRInteractorLineVisual m_UILineVisual;
    ...
    void FindUIControllerComponents()
    {
        ...
        {
            m_UILineVisual = m_UIControllerGameObject.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.Visuals.XRInteractorLineVisual>();
            if (m_UILineVisual == null)
        ...
        {
            m_UIInteractor = m_UIControllerGameObject.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor>();
            if (m_TeleportInteractor == null)
